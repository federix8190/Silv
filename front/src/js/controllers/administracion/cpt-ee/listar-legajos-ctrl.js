...
app.controller('ListarCptELegajoCtrl', ['$scope', 'CptEEService', 'LegajoService', '$controller', '$routeParams', '$location',
    function ($scope, service, LegajoService, $controller, $routeParams, $location) {
        ...
        $scope.updateVinculacion = function(vinculacion) {
            ...
            /*$scope.service.getLegajosAsignados($scope.parametrosListado)
