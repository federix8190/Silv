...
import py.com.ceamso.administracion.service.CuoService;
...
import py.com.ceamso.administracion.facade.CuoFacade;
 ...
 * @author vgayoso
 */
@Path("/administracion/cuo")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public class CuoResource extends WritableResource<Cuo, CuoService> {

    @Inject
    private CuoService service;

    @Override
    public CuoService getService() {
        return service;
    }

    @Inject
    private CuoFacade facade;
    
    public CuoFacade getFacade(){
        return facade;
    }
    ...
    public Response getCsv(@QueryParam("page") @DefaultValue("1") Integer pagina,
        ...
        ListaResponse<Cuo> list = getService().listar(inicio, cantidad, orderBy, orderDir, filtros);
