 ...
 * @author mbaez
 */
@Path("/administracion/cpt-ef")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public class CptFResource extends WritableResource<CptF, CptFService> {

    @Inject
    private CptFService service;

    @Override
    public CptFService getService() {
        return service;
    }
    
    @Inject
    private CptFFacade facade;
    
    public CptFFacade getFacade(){
        return facade;
    }
    ...
    @Path("/{id}/legajos")
    @Produces(MediaType.APPLICATION_JSON)
    public ListaResponse<CptEFLegajosView> getLegajos(@PathParam("id") Long id,
            @QueryParam("page") @DefaultValue("1") Integer pagina,
            @QueryParam("count") @DefaultValue("20") Integer cantidad,
            @QueryParam("sortBy") @DefaultValue("id") String orderBy,
            @QueryParam("sortOrder") @DefaultValue("DESC") String orderDir,
    ...
    //Obtiene el siguiente nro para CPTEF
    @GET
    ...
    public Response getCsv(@QueryParam("page") @DefaultValue("1") Integer pagina,
        ...
        ListaResponse<CptF> list = getService().listar(inicio, cantidad, orderBy, orderDir, filtros);
