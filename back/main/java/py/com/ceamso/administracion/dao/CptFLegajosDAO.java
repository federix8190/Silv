 ...
 * @author konecta
 */
public class CptFLegajosDAO extends ReadableDAO<CptEFLegajosView> {

    @Override
    public Class getEntity() {
        return CptEFLegajosView.class;
    }
    
    public ListaResponse<CptEFLegajosView> listarLegajos(Integer inicio, Integer cantidad, 
        ...
        sb.append("SELECT c FROM CptEFLegajosView c ");
        ...
        List<CptEFLegajosView> lista = q.getResultList();
        
        /*if (filtros != null && filtros.containsKey("mes")) {
            filtros.remove("mes");
        }*/
        sb = new StringBuilder();
        sb.append("SELECT COUNT(c) FROM CptEFLegajosView c ");
        buildWhere(sb, filtros);
        System.err.println(sb.toString());
        ...
        ListaResponse<CptEFLegajosView> res = new ListaResponse<>();
        res.setRows(lista);
        res.setCount(count);
        return res;
    }
