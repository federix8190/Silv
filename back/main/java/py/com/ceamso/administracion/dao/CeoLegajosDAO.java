 ...
 * @author konecta
 */
public class CeoLegajosDAO extends ReadableDAO<CeoLegajosView> {

    @Override
    public Class getEntity() {
        return CeoLegajosView.class;
    }
    
    public ListaResponse<CeoLegajosView> listarLegajos(Integer inicio, Integer cantidad, 
        ...
        sb.append("SELECT c FROM CeoLegajosView c ");
        ...
        List<CeoLegajosView> lista = q.getResultList();
        
        /**if (filtros != null && filtros.containsKey("mes")) {
            filtros.remove("mes");
        }**/
        sb = new StringBuilder();
        sb.append("SELECT COUNT(c) FROM CeoLegajosView c ");
        buildWhere(sb, filtros);
        System.err.println(sb.toString());
        ...
        ListaResponse<CeoLegajosView> res = new ListaResponse<>();
        res.setRows(lista);
        res.setCount(count);
        return res;
    }
