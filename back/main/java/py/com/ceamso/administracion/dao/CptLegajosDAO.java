 ...
 * @author daniel
 */
public class CptLegajosDAO extends ReadableDAO<CptLegajosView> {

    @Override
    public Class getEntity() {
        return CptLegajosView.class;
    }
    
    public ListaResponse<CptLegajosView> listar(Integer inicio, Integer cantidad, 
        ...
        sb.append("SELECT c FROM CptLegajosView c ");
        ...
        List<CptLegajosView> lista = q.getResultList();
        
        /*if (filtros != null && filtros.containsKey("mes")) {
            filtros.remove("mes");
        }*/
        sb = new StringBuilder();
        sb.append("SELECT COUNT(c) FROM CptLegajosView c ");
        buildWhere(sb, filtros);
        System.err.println(sb.toString());
        ...
        ListaResponse<CptLegajosView> res = new ListaResponse<>();
        res.setRows(lista);
        res.setCount(count);
        return res;
    }
